...
class C_cliente extends CI_Controller
{
    ...
    public function index(){
        ...
        $this->load->view('v_registrar_cliente', $data);
    }

    public function validar_sunat(){
        $add_ruc = trim($this->input->post('add_ruc',true));
        $des = $this->M_cliente->validar_sunat('simu_razon_social',$add_ruc,'ruc','razon_social');//validaciòn ruc o dni
        echo $des; 
    }
    ...
    public function registrar(){
        ...
        $result = $this->M_cliente->valida_duplicidad_datos('tb_usuarios2',$add_ruc,'dni');//validaciòn ruc o dni
        if($result<=0){
            $result = $this->M_cliente->valida_duplicidad_datos('tb_usuarios2',$add_usuario,'usuario');//validaciòn ruc o dni
    ...
    public function listar_criterio(){
        $resultado = $this->M_cliente->list('simu_criterio');
    ...
    public function agregar_proveedor(){
        ...
        $result = $this->M_cliente->insert('simu_proveedor',$array);
        echo $result;
    }

    public function listar_proveedor(){
        $resultado = $this->M_cliente->list('simu_proveedor');
        echo json_encode($resultado);
    }
    ...
    public function agregar_valor(){
        ...
        $result = $this->M_cliente->valida_criterio_x_proveedor('simu_cxproveedor',$id_criterio,$id_proveedor);
        if($result<=0){
            $array = array(
            ...
            $result = $this->M_cliente->insert('simu_cxproveedor',$array);
            echo $result;
        }else{
            echo 'error';
        }
    ...
    public function armar_matriz_valor(){
        $array_proveedores = $this->M_cliente->datos_tabla('simu_proveedor');
        $array_pesos = $this->M_cliente->datos_tabla('simu_criterio');
        $array_datos = $this->M_cliente->datos_tabla('simu_cxproveedor');
    ...
    public function armar_matriz_normalizada(){
        ...
        $this->M_cliente->truncate('simu_cxproveedor_step1');
        ...
        foreach ($array_proveedores as $key1) {
            ...
            foreach ($array_pesos as $key2) {
                ...
                $result = $this->M_cliente->insert('simu_cxproveedor_step1',$x);
    ...
    public function armar_matriz_normalizada_step2(){
        ...
        $this->M_cliente->truncate('simu_cxproveedor_step2');

        $array_proveedores = $this->M_cliente->datos_tabla('simu_proveedor');
        $array_pesos = $this->M_cliente->datos_tabla('simu_criterio');
        $array_datos = $this->M_cliente->datos_tabla('simu_cxproveedor_step1');
        ...
        foreach ($array_proveedores as $key1) {
            ...
            foreach ($array_pesos as $key2) {
                ...
                $result = $this->M_cliente->insert('simu_cxproveedor_step2',$x);
    ...
    public function armar_matriz_step3(){
        ...
        $this->M_cliente->truncate('simu_cxproveedor_step3');

        //$array_proveedores = $this->M_cliente->datos_tabla('simu_proveedor');
        $array_pesos = $this->M_cliente->datos_tabla('simu_criterio');
        $array_datos = $this->M_cliente->datos_tabla('simu_cxproveedor_step2');

        $arr_result2 =array();
        foreach ($array_pesos as $key2) {
            $id_criterio       = $key2['id'];
            $arr_min_max = $this->M_cliente->min_value('simu_cxproveedor_step2',$id_criterio);
            foreach ($arr_min_max as $key) {
                ...
                $result = $this->M_cliente->insert('simu_cxproveedor_step3',$x);
                array_push($arr_result2,$x);
            }
        }
    ...
    public function armar_matriz_step4(){
        ...
        $this->M_cliente->truncate('simu_cxproveedor_step4');

        $array_proveedores = $this->M_cliente->datos_tabla('simu_proveedor');
        $array_pesos = $this->M_cliente->datos_tabla('simu_criterio');
        $array_datos = $this->M_cliente->list_min_max('simu_cxproveedor_step2 as a','simu_cxproveedor_step3 as b');
        ...
        foreach ($array_proveedores as $key1) {
            ...
            $result = $this->M_cliente->insert('simu_cxproveedor_step4',$x);
            //array_push($arr_result2,$x);
            //break;
        }

        $array_datos = $this->M_cliente->list_step5('simu_cxproveedor_step4 as a','simu_proveedor as b');
        $cen = 'style="text-align:center;"';
    ...
    public function reiniciar(){
        $this->M_cliente->truncate('simu_proveedor');
        $this->M_cliente->truncate('simu_criterio');
        $this->M_cliente->truncate('simu_cxproveedor');
        $this->M_cliente->truncate('simu_cxproveedor_step1');
        $this->M_cliente->truncate('simu_cxproveedor_step2');
        $this->M_cliente->truncate('simu_cxproveedor_step3');
        $this->M_cliente->truncate('simu_cxproveedor_step4');
