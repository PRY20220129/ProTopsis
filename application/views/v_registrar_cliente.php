                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div style="display:flex;">
                                            <input type="text" class="form-control form-control-sm" id="add_ruc" placeholder="Ingrese RUC" required name="ruc" value="">
...
<script>
        ...
        submitHandler: function(form) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    {   
                        //if(response==10){
                            window.location.href = '/sistema/mod_evento';
                        //}else{
    ...
    function validar_sunat(){
        ...
        $.ajax({
          type:'post',
          contentType:false,
          url:'<?php echo base_url()?>C_cliente/validar_sunat',
          data: data,
          processData:false,
          beforeSend:function(){
          },
    ...
    function registrar(){
        ...
        $.ajax({
          type:'post',
          contentType:false,
          url:'<?php echo base_url()?>cliente/registrar',
          data: data,
          processData:false,
          beforeSend:function(){
          },
          success: function(response){
            if(response=='0'){
                    alerta_mensaje('¡Bienvenido!','Ahora eres Cliente, su registro ha sido completado con éxito.','success');
                    setTimeout(() => {
                        window.location.href = '/sistema/menu/';
                    }, 2500);
