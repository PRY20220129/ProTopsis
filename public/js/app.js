...
(function ($) {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "http://172.21.8.50/monitoreo/public/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "http://172.21.8.50/monitoreo/public/images/flags/spain.jpg";
            } else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "http://172.21.8.50/monitoreo/public/images/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "http://172.21.8.50/monitoreo/public/images/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "http://172.21.8.50/monitoreo/public/images/flags/russia.jpg";
            }
    ...
    function getLanguage() {
        ...
        $.getJSON('http://172.21.8.50/monitoreo/public/lang/' + language + '.json', function (lang) {
    ...
    function layoutSetting() {
        ...
        $("input[name='layout-direction']").on('change', function () {
            if($(this).val() == "ltr") {
                ...
                document.getElementById('bootstrap-style').setAttribute('href', 'http://172.21.8.50/monitoreo/public/css/bootstrap.min.css');
                document.getElementById('app-style').setAttribute('href', 'http://172.21.8.50/monitoreo/public/css/app.min.css');
            } else {
                document.getElementById('bootstrap-style').setAttribute('href', 'http://172.21.8.50/monitoreo/public/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', 'http://172.21.8.50/monitoreo/public/css/app-rtl.min.css');
